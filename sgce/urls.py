...
urlpatterns = [
    ...
    path('list_sports/', ListSportsView.as_view(), name='list_sports'),
    path('create_sport/', CreateSportView.as_view(), name='create_sport'),
    path('edit_sport/<int:id>/', EditSportView.as_view(), name='edit_sport'),
    path('delete_sport/<int:id>/', DeleteSportView.as_view(), name='delete_sport'),
    path('list_campus/', ListCampusView.as_view(), name='list_campus'),
    path('create_campus/', CreateCampusView.as_view(), name='create_campus'),
    path('edit_campus/<int:id>/', EditCampusView.as_view(), name='edit_campus'),
    path('delete_campus/<int:id>/', DeleteCampusView.as_view(), name='delete_campus'),
